            ...
            subsections: [
                {
                    ...
                    articles: [
                        {
                            num: '53',
                            title: 'Pedepsele principale',
                            fullText: `Pedepsele principale sunt:\na) detențiunea pe viață;\nb) închisoarea;\nc) amenda.`
                        },
                        {
                            num: '54',
                            title: 'Pedeapsa accesorie',
                            fullText: `Pedeapsa accesorie constă în interzicerea exercitării unor drepturi, din momentul rămânerii definitive a hotărârii de condamnare și până la executarea sau considerarea ca executată a pedepsei privative de libertate.`
                        }
                    ]
                },
                {
                    title: 'Capitolul II — Secțiunea 1 — Detențiunea pe viață',
                    articles: [
                        {
                            num: '56',
                            title: 'Regimul detențiunii pe viață',
                            fullText: `Detențiunea pe viață constă în privarea de libertate pe durată nedeterminată și se execută potrivit legii privind executarea pedepselor.`
                        },
                        {
                            num: '57',
                            title: 'Neaplicarea detențiunii pe viață',
                            fullText: `Dacă la data pronunțării hotărârii de condamnare inculpatul a împlinit vârsta de 65 de ani, în locul detențiunii pe viață i se aplică pedeapsa închisorii pe timp de 30 de ani și pedeapsa interzicerii exercitării unor drepturi pe durata ei maximă.`
                        },
                        {
                            num: '58',
                            title: 'Înlocuirea detențiunii pe viață',
                            fullText: `În cazul în care cel condamnat la pedeapsa detențiunii pe viață a împlinit vârsta de 65 de ani în timpul executării pedepsei, pedeapsa detențiunii pe viață poate fi înlocuită cu pedeapsa închisorii pe timp de 30 de ani și pedeapsa interzicerii exercitării unor drepturi pe durata ei maximă, dacă a avut o bună conduită pe toată durata executării pedepsei, a îndeplinit integral obligațiile civile stabilite prin hotărârea de condamnare, afară de cazul când dovedește că nu a avut nicio posibilitate să le îndeplinească, și a făcut progrese constante și evidente în vederea reintegrării sociale.`
                        },
                        {
                            num: '59',
                            title: 'Calculul pedepsei în cazul comutării sau înlocuirii pedepsei detențiunii pe viață',
                            fullText: `În cazul comutării sau înlocuirii pedepsei detențiunii pe viață cu pedeapsa închisorii, perioada de detențiune executată se consideră ca parte executată din pedeapsa închisorii.`
                        }
                    ]
                },
                {
                    title: 'Capitolul II — Secțiunea a 2-a — Închisoarea',
                    articles: [
                        {
                            num: '60',
                            title: 'Regimul închisorii',
                            fullText: `Închisoarea constă în privarea de libertate pe durată determinată, cuprinsă între 15 zile și 30 de ani, și se execută potrivit legii privind executarea pedepselor.`
                        }
                    ]
                },
                {
